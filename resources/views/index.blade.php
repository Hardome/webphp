    ...
    <div class="myRow grid between" style="padding: 0 52px;">
        ...
        <div class="content">
            ...
            <span>Мы - команда</span> профессиональных мастеров и преподавателей,
                предлагающих уникальные мастер-классы по различным направлениям: архитектурное моделирование, кулинария, и резьба по дереву.</p>

            <p><span>Наши ценности</span></p>
        ...
        <ul class="menu" style="height: 300px;">
            <li><a href=" ">Архитектурное моделирование</a></li>

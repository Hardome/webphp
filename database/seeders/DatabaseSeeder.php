    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
             [
                 ...
                 'role' => 1,
                 'created_at' => now(),
                 'password' => '$2y$12$uMX55ZVyGT7XqeeOpd7vK.JioLEzwGQ5.v./RPAUEjXsNLnvL2qu6' //adminadmin
             ],
            [
                'name' => 'user',
        ...
        DB::table('news')->insert([
            ...
            [
                ...
                'content' => 'Нейронные сети Google упростят создание приложений с поддержкой распознавания объектов. Смартфоны быстро стали одной из главных обителей искусственного интеллекта. На замену алгоритмам, которые работают в облаке и передают обработанную информацию на устройства через Интернет, пришло программное обеспечение, которое производит вычисления прямо на телефонах и планшетах. Google уделяет такому ПО особое внимание. Последний пример искусственного интеллекта от калифорнийского поискового гиганта — MobileNets, набор нейронных сетей машинного зрения, которые адаптированы под работу на мобильных устройствах. Есть нейронные сети разных размеров: чем больше сеть, тем более мощный процессор должен быть у телефона.
